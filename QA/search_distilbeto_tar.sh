...
for bs in "${batch_sizes[@]}"; do
    for lr in "${learning_rates[@]}"; do
        for n_epoch in "${epochs[@]}"; do
            ...
            --output_dir /home/sdonoso/data/all_results/qa/tar/albeto_base/epochs_"$n_epoch"_bs_"$bs"_lr_"$lr" \
            --do_train \
            --do_eval \
            ...
            --logging_dir /data/sdonoso/all_results/qa/tar/albeto_base/epochs_"$n_epoch"_bs_"$bs"_lr_"$lr" \
            --seed 42 \
